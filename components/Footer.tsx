        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left mb-16 items-start">
          ...
          <div className="flex flex-col items-center md:items-start space-y-6">
            ...
            <ul className="space-y-4 text-xs font-semibold uppercase tracking-widest">
              ...
              <li>
                <Link href="/culture" className="text-gray-400 hover:text-[#C8A400] transition-colors duration-200">
                  Our Culture
                </Link>
              </li>
              <li>
                <Link href="/media" className="text-gray-400 hover:text-[#C8A400] transition-colors duration-200">
                  Media
                </Link>
              </li>
              <li>
